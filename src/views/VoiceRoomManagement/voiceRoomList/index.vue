    ...
    <section ref="queryRef">
      <el-form :inline="true" class="search_left" :model="queryForm" @keyup.enter="fetchData(queryForm)">
        <el-form-item label="" prop="id">
          <el-input v-model="queryForm.id" placeholder="语音房ID" />
        </el-form-item>
        <el-form-item label="" prop="title">
          <el-input v-model="queryForm.title" placeholder="语音房名称" />
        </el-form-item>
        ...
        <el-form-item v-if="queryForm.state == '0'" class="el-select-extra" label="" prop="userId">
          <SelectNickname v-model="queryForm.userId" placeholder="创建人" select />
        </el-form-item>
